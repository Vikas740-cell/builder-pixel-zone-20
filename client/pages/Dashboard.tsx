...
const expenseCategories = [
  { id: 'food', label: 'Food', icon: Coffee, color: 'text-orange-500', bg: 'bg-orange-50' },
  { id: 'transport', label: 'Transport', icon: Car, color: 'text-blue-500', bg: 'bg-blue-50' },
  { id: 'bills', label: 'Bills', icon: Home, color: 'text-red-500', bg: 'bg-red-50' },
  { id: 'shopping', label: 'Shopping', icon: ShoppingBag, color: 'text-green-500', bg: 'bg-green-50' },
  { id: 'social', label: 'Social Life', icon: Gamepad2, color: 'text-purple-500', bg: 'bg-purple-50' },
  { id: 'other', label: 'Other', icon: Receipt, color: 'text-gray-500', bg: 'bg-gray-50' },
];
...
const recentExpenses = [
  { id: 1, description: 'Lunch at Restaurant', amount: 450, category: 'food', method: 'upi', date: '2024-01-15', time: '2:30 PM' },
  { id: 2, description: 'Uber to Office', amount: 180, category: 'transport', method: 'upi', date: '2024-01-15', time: '9:15 AM' },
  { id: 3, description: 'Grocery Shopping', amount: 1200, category: 'food', method: 'card', date: '2024-01-14', time: '7:45 PM' },
  { id: 4, description: 'Movie Tickets', amount: 600, category: 'social', method: 'upi', date: '2024-01-14', time: '6:00 PM' },
  { id: 5, description: 'Electricity Bill', amount: 2300, category: 'bills', method: 'net-banking', date: '2024-01-13', time: '11:30 AM' },
];
...
export default function Dashboard() {
  ...
  const handleQuickAdd = () => {
    if (amount && description && category && paymentMethod) {
      ...
      console.log('Adding expense:', { amount, description, category, paymentMethod });
      setAmount('');
      setDescription('');
      setCategory('');
      setPaymentMethod('');
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Here's your financial overview for January 2024</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-xs text-green-600">12% less than last month</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <p className="text-xs text-red-600">8% more than last month</p>
                </div>
              </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`h-10 w-10 rounded-full ${categoryInfo.bg} flex items-center justify-center`}>
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-500">
                          ...
                          <span>•</span>
                          <span className="capitalize">{expense.method.replace('-', ' ')}</span>
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
              ...
              {expenseCategories.slice(0, 4).map((category, index) => {
                ...
                return (
                  <div key={category.id} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className={`h-8 w-8 rounded-full ${category.bg} flex items-center justify-center`}>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-gray-500">{percentages[index]}%</p>
                    </div>
                  </div>
                );
              })}
              ...
              {['Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan'].map((month, index) => {
                ...
                return (
                  <div key={month} className="flex items-center justify-between">
                    <span className={`font-medium ${isCurrentMonth ? 'text-violet-600' : 'text-gray-700'}`}>
                      {month} 2024
                    </span>
                    <div className="flex items-center gap-3">
                      <div className="w-24 bg-gray-100 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${(amounts[index] / 16000) * 100}%` }}
                        />
                      </div>
                      <span className={`font-semibold min-w-[70px] text-right ${isCurrentMonth ? 'text-violet-600' : 'text-gray-900'}`}>
